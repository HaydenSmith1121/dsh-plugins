...
| `plugins/dsh-ark-plans/` | `dsh-ark-plans` | 0.2.0 | 0.1.6-alpha.1 | 火山方舟 **Agent Plan + Coding Plan** 模型接入（**组合配置 + 凭据诊断 + 额度显示**；额度走控制面 OpenTOP 签名查询，会话标题栏 pill 显示各周期已用百分比与刷新时间） |
...
| `dsh-ark-plans` | 0.2.0 | **本仓库自研** | HaydenSmith1121 | 本仓库 | MIT |
